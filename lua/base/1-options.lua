...
-- vim.g.default_colorscheme = "gruvbox-mater
-- vim.g.default_colorscheme = "mellifluous"
-- vim.g.default_colorscheme = "gruvbox-material"
-- Theme
vim.o.background = "dark"
vim.g.default_colorscheme = "immortal"
-- vim.g.gruvbox_material_foreground = "mix" -- ou "mix", "original"
...
vim.opt.scrolloff = 10000                                         -- Number of lines to leave before/after the cursor when scrolling. Setting a high value keep the cursor centered.
